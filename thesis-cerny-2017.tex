...
\begin{document}
	...
	This section describes all methods I found out. The description talks allways about the latest iteration of the prototype.
		...
		\subsection{GPS}
			...
			Once the user click navigate he is redirected to system
			
			
			The estimated accuracy is changed only when the sensor tells a value which is $\geq 5m$. This prevents the screen reader from infinite reeding loop, when it would be changing between i.e. $10m$ and $11m$. 
	...
	\section{Testing}
		...
		\subsection{Testing sessions}
			\subsubsection{1st testing}
			\subsubsection{2nd testing}
			\subsubsection{3rd testing}
			\subsubsection{4th testing}
			\subsubsection{5th testing}
		\section{Research sessions}
			\subsubsection{what they recognize on streets}
			\subsubsection{names of streets}
			\subsubsection{how they get lost}
			\subsubsection{how they write}
